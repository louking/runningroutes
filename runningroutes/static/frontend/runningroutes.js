...
$(function() {
    ...
    if ($('#rr-table-page').length == 0) return;
    ...
    // figure out runningroutes url from baseroutesurl (see layout.jinja2) and currently selected interest
    ...
    SVGOverlay.prototype.createsvg_ = function () {
        ...
        tip = d3.tip()
            ...
            // TODO: this needs work because dd needs to look like row
                .html(function(d) {
